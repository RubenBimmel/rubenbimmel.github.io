...
This is our very first step in creating a server. In the next part of this tutorial we will create a more advanced server using the Express module. You can read more about the NodeJS http module at [NodeJS HTTP Module - w3schools](https://www.w3schools.com/nodejs/nodejs_http.asp).