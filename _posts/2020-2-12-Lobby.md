...
<div class="fold-out-content">This allows us to exclusively send an event to our host. In the previous part of this tutorial we added the room property to game. This.room.emit() allows us to send events to all sockets connected to this game.</div>
</div>
